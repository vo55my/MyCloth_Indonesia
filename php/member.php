...
<body id="home" class="scrollspy">
    ...
    <ul class="slides">
      <li>
        ...
        <div class="caption center-align">
          <h2 class="red-text text-darken-3">Welcome, Member</h2>
      ...
      <div class="row">
        <?php foreach ($bike as $bike) : ?>
          <div class="col s12 m6">
            ...
            <center><a href="detail.php?id=<?= $bike['id']; ?>" class="waves-effect waves-light btn-large light-blue darken-3">Detail</a></center>
          </div>
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <div id="bw" class="parallax-container scrollspy">
    ...
    <div class="container bw">
      <h2 class="center-align white-text text-darken-2">B/W Edition</h2>
      <div class="row">
        <?php foreach ($black as $black) : ?>
          <div class="col s12 m6">
            <img src="../assets/img/Katalog/<?= $black['img']; ?>" data-caption="<?= $black['kode']; ?>" class="responsive-img materialboxed">
            <center><a href="detail.php?id=<?= $black['id']; ?>" class="waves-effect waves-light btn-large white black-text">Detail</a></center>
          </div>
        <?php endforeach; ?>
        <?php foreach ($white as $white) : ?>
          <div class="col s12 m6">
            <img src="../assets/img/Katalog/<?= $white['img']; ?>" data-caption="<?= $white['kode']; ?>" class="responsive-img materialboxed">
            <center><a href="detail.php?id=<?= $white['id']; ?>" class="waves-effect waves-light btn-large white black-text">Detail</a></center>
          </div>
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <div id="games" class="parallax-container scrollspy">
    ...
    <div class="container games">
      <h2 class="center-align yellow-text text-accent-3">Games Edition</h2>
      <div class="row">
        <?php foreach ($games as $games) : ?>
          <div class="col s12 m6">
            ...
            <center><a href="detail.php?id=<?= $games['id']; ?>" class="waves-effect waves-light btn-large yellow accent-4">Detail</a></center>
          </div>
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <div id="indo" class="parallax-container scrollspy">
    ...
    <div class="container indo">
      <h2 class="center-align red-text text-darken-3">Indonesia Edition</h2>
      <div class="row">
        <?php foreach ($indo as $indo) : ?>
          <div class="col s12 m6">
            ...
            <center><a href="detail.php?id=<?= $indo['id']; ?>" class="waves-effect waves-light btn-large red darken-3">Detail</a></center>
          </div>
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <div id="pubg" class="parallax-container scrollspy">
    ...
    <div class="container pubg">
      <h2 class="center-align black-text">PUBG Edition</h2>
      <div class="row">
        <?php foreach ($pubg as $pubg) : ?>
          <div class="col s12 m6">
            ...
            <center><a href="detail.php?id=<?= $pubg['id']; ?>" class="waves-effect waves-light btn-large black">Detail</a></center>
          </div>
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <div id="space" class="parallax-container scrollspy">
    ...
    <div class="container space">
      <h2 class="center-align amber-text text-accent-1">Space Edition</h2>
      <div class="row">
        <?php foreach ($space as $space) : ?>
          <div class="col s12 m6">
            ...
            <center><a href="detail.php?id=<?= $space['id']; ?>" class="waves-effect waves-light btn-large amber accent-2">Detail</a></center>
          </div>
        <?php endforeach; ?>
      </div>
    </div>
